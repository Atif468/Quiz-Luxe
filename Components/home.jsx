    ...
    return (
            <div className="h-full text-white">
                <div className="h-screen  grid place-content-center sm:p-3">
                    ...
                    <Link to="/Select" className="hover:bg-blue-600 text-3xl bg-blue-500 rounded-lg m-10  sm:h-10 sm:w-20 md:h-12 md:w-28 text-center pt-2 lg:h-14 lg:w-32">Next</Link>
                </div>
            </div >
